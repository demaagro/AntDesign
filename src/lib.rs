...
#[derive(Debug)]
pub struct AntDesignProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AntDesignProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AntDesign processing");
    
    let mut processor = AntDesignProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AntDesignProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AntDesignProcessor::new(false);
